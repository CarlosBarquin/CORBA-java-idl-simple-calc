 ...
 implements CalcApp.CalcOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("complexSum", new java.lang.Integer (4));
    _methods.put ("complexSub", new java.lang.Integer (5));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 4:  // CalcApp/Calc/complexSum
       {
         CalcApp.Complex a = CalcApp.ComplexHelper.read (in);
         CalcApp.Complex b = CalcApp.ComplexHelper.read (in);
         CalcApp.Complex $result = null;
         $result = this.complexSum (a, b);
         out = $rh.createReply();
         CalcApp.ComplexHelper.write (out, $result);
         break;
       }

       case 5:  // CalcApp/Calc/complexSub
       {
         CalcApp.Complex a = CalcApp.ComplexHelper.read (in);
         CalcApp.Complex b = CalcApp.ComplexHelper.read (in);
         CalcApp.Complex $result = null;
         $result = this.complexSub (a, b);
         out = $rh.createReply();
         CalcApp.ComplexHelper.write (out, $result);
         break;
       }
