...
public class _CalcStub extends org.omg.CORBA.portable.ObjectImpl implements CalcApp.Calc
{
  ...
  public CalcApp.Complex complexSum (CalcApp.Complex a, CalcApp.Complex b)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("complexSum", true);
                CalcApp.ComplexHelper.write ($out, a);
                CalcApp.ComplexHelper.write ($out, b);
                $in = _invoke ($out);
                CalcApp.Complex $result = CalcApp.ComplexHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
  ...
  public CalcApp.Complex complexSub (CalcApp.Complex a, CalcApp.Complex b)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("complexSub", true);
                CalcApp.ComplexHelper.write ($out, a);
                CalcApp.ComplexHelper.write ($out, b);
                $in = _invoke ($out);
                CalcApp.Complex $result = CalcApp.ComplexHelper.read ($in);
